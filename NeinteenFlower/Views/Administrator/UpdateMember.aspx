<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateMember.aspx.cs" Inherits="NeinteenFlower.Views.Administrator.UpdateMember" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Button ID="UpdateButton" runat="server" Text="Update Member" OnClick="UpdateButton_Click" />
        </div>
    </form>
</body>
</html>
