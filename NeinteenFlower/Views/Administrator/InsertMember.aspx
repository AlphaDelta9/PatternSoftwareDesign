<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertMember.aspx.cs" Inherits="NeinteenFlower.Views.Administrator.InsertMember" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Button ID="InsertButton" runat="server" Text="Insert Member" OnClick="InsertButton_Click" />
        </div>
    </form>
</body>
</html>
