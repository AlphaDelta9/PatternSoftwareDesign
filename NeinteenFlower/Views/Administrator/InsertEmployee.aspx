<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertEmployee.aspx.cs" Inherits="NeinteenFlower.Views.Administrator.InsertEmployee" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Button ID="InsertButton" runat="server" Text="Insert Employee" OnClick="InsertButton_Click" />
        </div>
    </form>
</body>
</html>
