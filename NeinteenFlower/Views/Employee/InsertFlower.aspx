<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertFlower.aspx.cs" Inherits="NeinteenFlower.Views.Employee.InsertFlower" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Button ID="InsertButton" runat="server" Text="Insert Flower" OnClick="InsertButton_Click" />
        </div>
    </form>
</body>
</html>
